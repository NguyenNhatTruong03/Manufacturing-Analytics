...
--    bi LOAI KHOI cac tong thoi gian (Planned/Run/Downtime) vi tat ca 17 dong
    ...
    select
        *,
        case
            ...
            when oee_category_raw ilike 'pm%'        then 'PLANNED_DOWNTIME'
            when oee_category_raw ilike 'no%'        then 'PLANNED_DOWNTIME'
            else 'UNKNOWN'
